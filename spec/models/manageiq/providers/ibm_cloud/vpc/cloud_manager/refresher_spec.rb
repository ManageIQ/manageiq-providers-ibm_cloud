...
describe ManageIQ::Providers::IbmCloud::VPC::CloudManager::Refresher, :vcr => {:allow_playback_repeats => true} do
  ...
  def assert_specific_floating_ip(mgmt)
    floating_ip = mgmt.floating_ips.find_by(:ems_ref => "r014-1892eee4-79ab-4d26-8efd-4c5759fc03fc")
    expect(floating_ip).to have_attributes(
      ...
      :network_port     => mgmt.network_ports.find_by(:ems_ref => "0777-2f20fad9-dea8-4f28-ac7b-8d1b77a3230d"),
      :vm               => mgmt.vms.find_by(:ems_ref => "0777_a9ee9e6a-231a-4a3c-b9cb-fc83d25114a2"),
      :status           => "available"
    )
  end
